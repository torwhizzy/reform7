...
<div id="billboard" class="dark hasbillboard" style="background-image: linear-gradient(rgba(4, 9, 30, 0.7), rgba(4, 9, 30, 0.7)),url(../_assets/img/layouts/background.jpg);min-height: 50vh; width: 100%;">
    <div class="text-box" style = "height: 100px; margin: 10em 0;">
        <div class="sec-title-style1 text-center max-width">
            <div class="title">The word of God</div>
            <div class="text">
            ...
            <div class="bottom-text">
                <p>We are followers of Jesus Christ, anointed and consumed with the passion of the Holy Spirit in
                    love and grace, to see Africa become the people God has purposed her to be.</p>
            </div>
        </div>
    </div>
...
<section class="sec-001">
    ...
    <div class="s-001-div-container">

        <div class="s-001-div">
            <div class="s-001-img">
                <img src="../_assets/images/slide-3.jpg" alt="">
            </div>
            <div class="s-001-content">
                <h4>The power of God and his mercy</h4>
                <p>His is whereby God makes a people (or person) and their way of life ‘right’ from worse, corrupt, or
                    evil state
                    to good, blessed and prosperous state that is aligned with His original plan and purpose for them.
                </p>
                <div class="shi">
                    <a href="#" class="text-btn red-btn">Listen to message</a>
                </div>
            </div>
        </div>
        <div class="s-001-div">
            <div class="s-001-img">
                <img src="../_assets/images/slide-5.jpg" alt="">
            </div>
            <div class="s-001-content">
                <h4>The power of God and his mercy</h4>
                <p>His is whereby God makes a people (or person) and their way of life ‘right’ from worse, corrupt, or
        ...
        <div class="s-001-div">
            <div class="s-001-img">
                <img src="../_assets/images/slide-6.jpg" alt="">
            </div>
            <div class="s-001-content">
                <h4>The power of God and his mercy</h4>
                <p>His is whereby God makes a people (or person) and their way of life ‘right’ from worse, corrupt, or
